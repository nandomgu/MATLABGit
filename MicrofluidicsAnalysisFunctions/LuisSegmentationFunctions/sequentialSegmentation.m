...
channels = {'GFP','cy5','Brightfield_001','Brightfield_002','Brightfield_004','Brightfield_005'};
...
figure
allchannels= {d.cExperiment.searchString, channels{:}}
for j=1:numel(allchannels)
    
subplot(1,numel(allchannels),j)
