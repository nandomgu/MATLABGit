...
function modelh= mechModelX1(params, args)

description=['simulation of Hxt in all mutants and 3 glucose concentrations (0.2 0.4 1)'...
              'this time having mig1 repressing mth1 rather than mig2'             
];
...
DMTH1= 1/ (1 + (MIG1/KrepM2MT)^hillrepM2MT)  - (degMT+ basaldegMT)*MTH1 ;
