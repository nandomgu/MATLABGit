...
function modelh= mechModel7(params, args)

description=['mechModel7- glucose deg mth1'  ...
             'glucose deg std1'...
             'mth1 rep Std1' ...
             'std1 inhibits mig1' ...
...
DHXT=  VHXT/ (1+ (MIG1/KrepHMG)^hillHMG +(MTH1/KrepHMT)^hillHMT +(STD1/KrepHST)^hillrepHST) - deg*HXT;
